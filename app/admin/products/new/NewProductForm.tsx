        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <select required name="category" className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-[#f4d7b1] focus:border-[#201711] outline-none transition">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="flex gap-2">
                <input name="color_picker" type="color" defaultValue="#8c5a3c" onChange={(e) => {
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input name="accentColor_picker" type="color" defaultValue="#f4d7b1" onChange={(e) => {
                  const txtInput = document.getElementById("accentColor_txt") as HTMLInputElement;
                  if (txtInput) txtInput.value = e.target.value;
                }} className="h-10 w-10 rounded cursor-pointer" />
                <input required id="accentColor_txt" name="accentColor" type="text" defaultValue="#f4d7b1" className="flex-1 border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-[#f4d7b1] focus:border-[#201711] outline-none transition" dir="ltr" />
              </div>
            </div>
          </div>
        </div>
